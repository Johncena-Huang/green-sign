<template>
  <Teleport to="body">
    <Transition name="scale" :duration="500" appear>
      <div class="message-window-popup" v-if="popupState.show">
        <div class="message-window-popup__dialog inner">
          <div
            class="message-window-popup__inner"
            :class="isType2 ? 'message-window-popup__inner--two-btns' : ''"
          >
            ...
            <div class="message-window-popup__btn-group">
              <q-btn
                v-if="isType2"
                class="message-window-popup__btn message-window-popup__btn--cancel"
                label="取消"
                dense
              />
              <q-btn
...
const { popupState, closePopup } = useNotify();
const isType2 = computed(() => popupState.buttonType === 2);
</script>
